...
class ClienteAccount(Base):
    ...
    numero_civico = Column(String(20), nullable=True)
    citta = Column(String(100), nullable=True)
    cap = Column(String(10), nullable=True)
    provincia = Column(String(50), nullable=True)
    paese = Column(String(100), nullable=True, default="Italia")
    indirizzo_nome_destinatario = Column(String(100), nullable=True)
    indirizzo_cognome_destinatario = Column(String(100), nullable=True)
