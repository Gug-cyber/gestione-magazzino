        ...
        <div className="store-filters" style={{
          ...
          <div className="store-filter-checks" style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', alignItems: 'center' }}>
            <label style={{ 
              ...
              cursor: 'pointer', 
              fontSize: '13px', 
              color: disponibiliOnly ? 'var(--color-primary)' : 'var(--color-text-secondary)',
              fontWeight: disponibiliOnly ? '600' : '400',
              padding: '8px 14px',
              borderRadius: '8px',
              backgroundColor: disponibiliOnly ? 'rgba(var(--color-primary-rgb, 59, 130, 246), 0.1)' : 'transparent',
              border: `1px solid ${disponibiliOnly ? 'var(--color-primary)' : 'var(--color-border)'}`,
              ...
              <span style={{
                ...
                height: '18px',
                borderRadius: '4px',
                border: `2px solid ${disponibiliOnly ? 'var(--color-primary)' : 'var(--color-border)'}`,
                backgroundColor: disponibiliOnly ? 'var(--color-primary)' : 'transparent',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                transition: 'all 200ms ease',
            ...
            <label style={{ 
              ...
              cursor: 'pointer', 
              fontSize: '13px', 
              color: offerteSolo ? 'var(--color-success)' : 'var(--color-text-secondary)',
              fontWeight: offerteSolo ? '600' : '400',
              padding: '8px 14px',
              borderRadius: '8px',
              backgroundColor: offerteSolo ? 'rgba(34, 197, 94, 0.1)' : 'transparent',
              border: `1px solid ${offerteSolo ? 'var(--color-success)' : 'var(--color-border)'}`,
              transition: 'all 200ms ease',
            }}>
              <input
                type="checkbox"
              ...
              <span style={{
                ...
                height: '18px',
                borderRadius: '4px',
                border: `2px solid ${offerteSolo ? 'var(--color-success)' : 'var(--color-border)'}`,
                backgroundColor: offerteSolo ? 'var(--color-success)' : 'transparent',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                transition: 'all 200ms ease',
